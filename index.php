...
<section class="container-fluid h-100">
    ...
    <section class="row justify-content-center align-self-center text-center">
        <section class="col-10">
            <p>Haarlem is a busy city, with a rich history and beautiful statues and other sights.
                Walk trough cozy streets in the heart of Haarlem and discover a large variety of stores. Sit down at one
                of the
                many pubs with your friends for a drink, or visit one of the many museums or theaters in Haarlem.
                Haarlem even has a beach
    ...
    <section class="row justify-content-center align-self-center text-center">
        <section class="col-10">
            <p> To show you Haarlem, we've organised a few events in it! It's called "The Haarlem Festival". If you love
                <a href="dance.php">dance</a> or
    ...
    <section class="row justify-content-center align-self-center text-center">
        <section class="col-3">
            <section class="col-12" style="background-color: black; margin-top: 2%;">
                ...
                <p style="margin-bottom: 0px; padding: 10%" class="discoverBlockContent">Our dance acts focus on dance,
                    house, techno and trance.
                    Haarlem Festival offers 6 of the best DJs in the world. They will perform in back2back and club
                    sessions.
                </p>
            </section>
    ...
    <section class="row justify-content-center align-self-center text-center">
        <section class="col-3">
            <section class="row justify-content-center align-self-center text-center"><img
                        src="img/Icons/thisis_musicnote.png" width="32" height="32"></section>
            <section class="row" style="padding: 2%;"><p>Together we create an unforgettable musical memory. Our own
                    stories with national and international artists.</p></section>
        </section>

        <section class="col-3">
            <section class="row justify-content-center align-self-center text-center"><img
                        src="img/Icons/thisis_food.png" width="32" height="32"></section>
            <section class="row" style="padding: 2%;"><p>Enjoy the scents and taste of the national and international
                    dishes of the restaurants nearby.</p></section>
        </section>

        <section class="col-3">
            <section class="row justify-content-center align-self-center text-center"><img src="img/Icons/like.png">
            </section>
            <section class="row" style="padding: 2%;"><p>Discover, meet, experience. Find out what the music does to
                    you. Meet and share your experiences.</p></section>
        </section>
    </section>
</section>
</body>
