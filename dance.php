...
<section class="container-fluid">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="get">
        <section class="row h-100 align-items-center" style="background-color: #C0C0C0">
            <section class="col-3 text-center fonttickets"
                     style="border-width:0.2em; border-style: solid; padding: 0.5em;"><a href="dance.php?day=friday"
                                                                                         style="color: black;">Friday
                    27th of July</a></section>
            <section class="col-3 text-center fonttickets"
                     style="border-width:0.2em; border-style: solid; padding: 0.5em;"><a href="dance.php?day=saturday"
                                                                                         style="color: black;">Saturday
                    28th of July</a></section>
            <section class="col-3 text-center fonttickets"
                     style="border-width:0.2em; border-style: solid; padding: 0.5em;"><a href="dance.php?day=sunday"
                                                                                         style="color: black;">Sunday
                    29th of July</a></section>
            <section class="col-3 text-center fonttickets"
                     style="border-width:0.2em; border-style: solid; padding: 0.5em;"><a href="dance.php"
